...
public class RefreshTokenRequest extends TokenRequest {
    ...
    public RefreshTokenRequest() {
        ...
        if(tokenConfig != null) {
            ...
            if(tokenConfig.getRefreshToken() != null) {
                setClientId(tokenConfig.getRefreshToken().getClientId());
                setClientSecret(tokenConfig.getRefreshToken().getClientSecret());
                setUri(tokenConfig.getRefreshToken().getUri());
                setScope(tokenConfig.getRefreshToken().getScope());
            }
        }
    }
