...
public class ClientCredentialsRequest extends TokenRequest {
    ...
    public ClientCredentialsRequest() {
        ...
        if(tokenConfig != null) {
            ...
            if(tokenConfig.getClientCredentials() != null) {
                setClientId(tokenConfig.getClientCredentials().getClientId());
                setClientSecret(tokenConfig.getClientCredentials().getClientSecret());
                setUri(tokenConfig.getClientCredentials().getUri());
                
                setScope(tokenConfig.getClientCredentials().getScope());
            }
        }
    }
}
