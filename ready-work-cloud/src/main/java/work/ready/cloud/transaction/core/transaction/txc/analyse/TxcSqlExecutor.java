...
public interface TxcSqlExecutor {
    ...
    List<InvolvedRecord> involvedPrimaryKeys(Connection connection, SelectImageParams selectImageParams, int lockType) throws SQLException;

    void applyUndoLog(Map<String, List<StatementInfo>> statementInfo) throws SQLException;
}
