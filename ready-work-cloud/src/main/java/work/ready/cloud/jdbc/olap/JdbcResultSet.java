...
import static work.ready.cloud.jdbc.olap.EsType.*;
import static work.ready.cloud.jdbc.olap.JdbcDateUtils.*;
...
class JdbcResultSet implements ResultSet, JdbcWrapper {
    ...
    JdbcResultSet(JdbcConfiguration cfg, JdbcStatement statement, Cursor cursor) {
