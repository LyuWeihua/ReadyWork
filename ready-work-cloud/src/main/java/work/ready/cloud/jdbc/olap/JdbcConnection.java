...
public class JdbcConnection implements Connection, JdbcWrapper {
    ...
    public JdbcConnection(JdbcConfiguration connectionInfo, boolean checkServer) throws SQLException {
        cfg = connectionInfo;
    ...
    int esInfoMajorVersion() throws SQLException {
        return client.serverInfo().version.getMajorVersion();
    }

    int esInfoMinorVersion() throws SQLException {
        return client.serverInfo().version.getMinorVersion();
    }
}
