...
class JdbcDatabaseMetaData implements DatabaseMetaData, JdbcWrapper {
    ...
    public String getDatabaseProductVersion() throws SQLException {
        return con.client.serverInfo().version.toString();
    }
    ...
    public int getDriverMajorVersion() {
        return ClientVersion.CURRENT.getMajorVersion();
    }

    @Override
    public int getDriverMinorVersion() {
        return ClientVersion.CURRENT.getMinorVersion();
    }
    ...
    private static class InMemoryCursor implements Cursor {
        ...
        @Override
        public boolean next() {
            if (!CollectionUtil.isEmpty(data) && row < data.length - 1) {
                row++;
                return true;
            }
            return false;
        ...
        public int batchSize() {
            return CollectionUtil.isEmpty(data) ? 0 : data.length;
        }
