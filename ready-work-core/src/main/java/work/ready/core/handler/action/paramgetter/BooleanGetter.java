...
public class BooleanGetter extends ParamGetter<Boolean> {
	...
	@Override
	public Boolean get(Action action, Controller c) {
		return c.getParamToBoolean(getParameterName(),getDefaultValue());
	}
