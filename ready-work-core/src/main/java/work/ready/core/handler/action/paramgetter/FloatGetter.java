...
public class FloatGetter extends ParamGetter<Float> {
	...
	@Override
	public Float get(Action action, Controller c) {
		...
		try {
			...
			throw new ApiException(new Status(PARAM_PARSE_EXCEPTION, value, Float.class));
		}
	}
