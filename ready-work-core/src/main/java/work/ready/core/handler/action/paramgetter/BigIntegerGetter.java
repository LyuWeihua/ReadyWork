...
public class BigIntegerGetter extends ParamGetter<BigInteger> {
	...
	@Override
	public BigInteger get(Action action, Controller c) {
		...
		try {
			...
			throw new ApiException(new Status(PARAM_PARSE_EXCEPTION, value, BigInteger.class));
		}
	}
